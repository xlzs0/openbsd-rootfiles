...
//static char *font = "monospace:size=10.75:antialias=true:autohint=false:hinting=true:rgba=0:embeddedbitmap=true:scalable=true:color=false:dpi=89";
...
static const char *colorname[] = {
	...
	"#0A0A0A", /* default background colour */
};
